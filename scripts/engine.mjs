const RANDOM_TRAITS = {
  ...
  hairStyles: [
    ...
    "twists",
    "box braids",
    "a puff of curls tied up",
    "a wash-and-go curl",
    "a buzzed undercut",
    "a man bun",
    "a top knot",
    "a crew cut",
    "a slicked-back style",
    "a side-swept fringe",
    "blunt bangs",
    "curtain bangs",
    "a shag cut",
    ...
    "a low bun",
    "a neat side part",
    "hair scraped into a tight ponytail",
    "bedhead, just woken up"
  ],
  hairColors: [
    "black",
    "dark brown",
    ...
    "highlighted with balayage",
    "henna red",
    "black with a few greys coming through"
  ],
  expressions: [
